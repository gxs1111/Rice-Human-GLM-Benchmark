...
SPECIES_CONFIG = {
    'species1': {
        'gff': 'PATH_TO_SPECIES1_GFF3.gff3',
        'fasta': 'PATH_TO_SPECIES1_GENOME.fa'
    },
    'species2': {
        'gff': 'PATH_TO_SPECIES2_GFF3.gff3',
        'fasta': 'PATH_TO_SPECIES2_GENOME.fa'
    },
    'species3': {
        'gff': 'PATH_TO_SPECIES3_GFF3.gff3',
        'fasta': 'PATH_TO_SPECIES3_GENOME.fa'
    },
    'species4': {
        'gff': 'PATH_TO_SPECIES4_GFF3.gff3',
        'fasta': 'PATH_TO_SPECIES4_GENOME.fa'
    },
    'species5': {
        'gff': 'PATH_TO_SPECIES5_GFF3.gff3',
