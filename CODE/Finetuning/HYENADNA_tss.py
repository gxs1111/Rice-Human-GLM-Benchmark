...
POSITIVE_FASTA = "<POSITIVE_TSS_FASTA>"
NEGATIVE_FASTA = "<NEGATIVE_TSS_FASTA>"
...
positive_data = load_fasta(POSITIVE_FASTA, label=1)
negative_data = load_fasta(NEGATIVE_FASTA, label=0)
...
train_dataset = TSSDataset(train_seq, train_labels, tokenizer, MAX_LENGTH)
val_dataset = TSSDataset(val_seq, val_labels, tokenizer, MAX_LENGTH)
test_dataset = TSSDataset(test_seq, test_labels, tokenizer, MAX_LENGTH)
