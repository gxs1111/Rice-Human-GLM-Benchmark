...
sequences, species = load_data(DATA_PATH)

label_encoder = LabelEncoder()
labels = label_encoder.fit_transform(species)
...
train_sequences, train_labels, val_sequences, val_labels, test_sequences, test_labels = stratified_split_dataset(sequences, labels)
...
with open(os.path.join(OUTPUT_DIR, "test_metrics.txt"), "w") as f:
    ...
    for key, value in test_results.items():
        f.write(f"{key}: {value}\n")
    f.write(f"\nSpecies class mapping: {dict(enumerate(class_names))}\n")
