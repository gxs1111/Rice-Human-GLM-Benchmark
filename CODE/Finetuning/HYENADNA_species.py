...
labels = np.array([label_mapping[spec] for spec in species])
...
train_dataset = SpeciesDataset(train_seq, train_labels, tokenizer, MAX_LENGTH)
val_dataset = SpeciesDataset(val_seq, val_labels, tokenizer, MAX_LENGTH)
test_dataset = SpeciesDataset(test_seq, test_labels, tokenizer, MAX_LENGTH)
