...
PROMOTER_PATH = "<PROMOTER_FASTA>"
NON_PROMOTER_PATH = "<NON_PROMOTER_FASTA>"
...
promoter_sequences, promoter_labels = load_fasta(PROMOTER_PATH, 1)
non_promoter_sequences, non_promoter_labels = load_fasta(NON_PROMOTER_PATH, 0)
