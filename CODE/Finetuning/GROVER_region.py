...
print("Loading region_human.csv data...")
...
expected_labels = ['exon', 'intron', 'intergenic']
...
for i in range(min(3, len(data))):
    ...
    region = label_encoder.inverse_transform([label])[0]
    ...
    print(f"Label: {region} (encoded: {label})")
